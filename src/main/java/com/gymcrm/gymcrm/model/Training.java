...
public class Training {
    ...
    public Training(Integer id, Trainee trainee, Trainer trainer, TrainingType trainingType, String trainingName, LocalDate trainingDate, Integer trainingDuration) {
        this.id = id;
